...
"[project]/app/api/personnel-changes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await supabase.from("personnel_changes").select("*").order("effect_date", {
        ascending: false
    });
...
async function POST(request) {
    ...
    const { data, error } = await supabase.from("personnel_changes").insert(body).select().single();
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
async function PUT(request) {
    ...
    const { data, error } = await supabase.from("personnel_changes").update({
        ...updates,
...
async function DELETE(request) {
    ...
    const { error } = await supabase.from("personnel_changes").delete().eq("id", id);
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1baf8b8f._.js.map