...
"[project]/app/api/employee-contracts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const { data, error } = await supabase.from("employee_contracts").insert(body).select().single();
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
async function PUT(request) {
    ...
    const { data, error } = await supabase.from("employee_contracts").update({
        ...updates,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__753689d1._.js.map